...
const List<SupportedCity> kSupportedCities = [
  SupportedCity(
      city: 'Bangalore', countryCode: 'IN', label: 'Bangalore, India'),
  ...
  SupportedCity(
      city: 'New Delhi', countryCode: 'IN', label: 'New Delhi, India'),
  SupportedCity(
      city: 'New York', countryCode: 'US', label: 'New York, United States'),
  SupportedCity(
      city: 'Singapore', countryCode: 'SG', label: 'Singapore, Singapore'),
];
...
List<SupportedCity> sortedIndiaCities() {
  final list = kSupportedCities
      .where((c) => c.countryCode == kIndiaCountryCode)
      .toList();
...
String cityCompositeValue(String city, String countryCode) =>
    '$city|$countryCode';
